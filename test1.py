...
class Face_Recognizer:
    ...
    def is_real_face(self, img, face_rect):
                ...
                if (self.current_frame_face_cnt == self.last_frame_face_cnt) and (
                    ...
                    if self.current_frame_face_cnt == 0:
                        ...
                        for i in range(len(faces)):
                            ...
                            # Anti-spoofing check
                            if not self.is_real_face(img_rd, faces[i]):
                                logging.debug("  Face recognition result: Spoof detected")
                                self.current_frame_face_name_list[i] = "spoof"
                        ...
                        for k in range(len(faces)):
                            ...
                            if min(self.current_frame_face_X_e_distance_list) < 0.4 and self.current_frame_face_name_list[k] != "spoof":
                                ...
                                logging.debug("  Face recognition result: Unknown person or spoof detected")
